...
|---|---|---|
| [linelens](tools/linelens/) | File length linter — detects files exceeding a line limit | `v0.3.1` |
| [dupelens](tools/dupelens/) | Code duplication detector (Rabin-Karp, language-agnostic) | `v0.3.1` |
| [secretlens](tools/secretlens/) | Secret and credential detector (AWS keys, GitHub tokens, JWT, PEM, etc.) | `v0.3.1` |
| [testlens](tools/testlens/) | Test coverage detector — finds source files without tests (multi-language) | `v0.3.1` |
...
open-harness/
├── tools/
│   ├── linelens/          ← v0.3.1 (file length linter, 100% coverage)
│   ├── dupelens/          ← v0.3.1 (duplicate detector, Rabin-Karp, 100% coverage)
│   ├── secretlens/        ← v0.3.1 (secret/credential detector, 100% coverage)
│   └── testlens/          ← v0.3.1 (test coverage detector, multi-language, 100% coverage)
├── npm/
