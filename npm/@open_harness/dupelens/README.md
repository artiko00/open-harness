...
> **Same tool, other ecosystems**: also available on **PyPI** ([`open-harness-dupelens`](https://pypi.org/project/open-harness-dupelens/)) and on **Packagist** (`open-harness/dupelens`). Identical binary, identical config; pick the registry that matches your stack.
