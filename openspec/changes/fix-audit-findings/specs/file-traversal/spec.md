...
Recorrido del árbol de archivos compartido por linelens 0.2.1, dupelens 0.2.1, secretlens 0.2.1 y
testlens 0.2.5. Hoy los cuatro se cuelgan indefinidamente ante un FIFO y descartan archivos en
silencio, de modo que un `OK:` no distingue "analicé y está limpio" de "no pude leer nada".
