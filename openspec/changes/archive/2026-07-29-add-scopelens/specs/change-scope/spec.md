...
Medición del alcance de un cambio: cuántos archivos distintos toca una rama respecto de su base de
merge, y si ese número respeta el presupuesto configurado. Capability nueva, provista por
`scopelens 0.1.0`.
