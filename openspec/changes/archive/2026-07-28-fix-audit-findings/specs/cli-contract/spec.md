...
Superficie de línea de comandos común a linelens 0.2.1, dupelens 0.2.1, secretlens 0.2.1 y
testlens 0.2.5. Hoy solo dupelens tiene `--format json` y `--verbose`, solo dupelens valida `--dir`,
testlens es el único sin prefijo `OK:` ni línea `SUMMARY:` y el único que manda diagnóstico a stdout.
