...
Motor de detección de secretos de secretlens 0.2.1. Recall medido sobre el fixture de auditoría:
25% (5 de 20). Un `.env` sin comillas no produce ningún hallazgo, un comentario `# example`
suprime la línea entera, y agregar un pattern propio desactiva los 8 built-in.
